...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('public/skins/_all-skins.min.css') }}">
  <style type="text/css">
    .modal-backdrop {
      /* bug fix - no overlay */    
      display: none;    
...
<body class="hold-transition skin-blue sidebar-mini" >
  <div class="wrapper" id="appku">
    ...
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-lg"><b>Personalisasi</b></span>
      </a>
                ...
                <li>                  
                  <ul class="menu">
                    <li v-for="(user, index) in usersApplet" :key="index">
                      <a href="#">
                        <div class="pull-left">
                          <img :src="`https://persopaperless.cardtech.co.id/ktp/public/foto/300/${ user.foto }`" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                          @{{ user.name }}
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        {{-- <li class="{{ $side==='virgin' ? 'active' : '' }}"><a href="{{ route('preperso.index', 3) }}"><i class="fa fa-file-powerpoint-o text-blue"></i> <span>virgin</span></a></li>           --}}
        <li class="header"></li>              
        ...
        <li class="{{ $side==='record_virgin' ? 'active' : '' }}"><a href="{{ route('record.index', 3) }}"><i class="fa fa-registered text-yellow"></i> <span>Record Virgin</span></a></li>       
        <li class="header"></li>              
        <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ $side==='applet_pengganti' ? 'active' : '' }}"><a href="{{ route('applet_pengganti') }}"><i class="fa fa-columns text-red"></i><span>Applet Pengganti</span></a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      {{-- <button @click="sendMonitoring('applet')" class="btn btn-primary" type="button">Monitoring</button> --}}
...
<script>  
  ...
  var app = new Vue({ 
    ...
    data: {
      ...
      chartData: {
        columns: ['tgl', 'tagihan'],
        rows: [{'tgl' : '2/6/2018','tagihan' : '1331'},{'tgl' : '8/6/2018','tagihan' : '4331'}]
      },
      notifikasi : false
    },
    computed: {
    ...
    methods: {
      ...
      online(){        
        ...
        .listenForWhisper('monitoring', monitoring => {                          
          if(this.side =='monitoring'){
